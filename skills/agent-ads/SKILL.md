...
- Shell override / CI: provider-specific env vars (e.g. `META_ADS_ACCESS_TOKEN`, `GOOGLE_ADS_REFRESH_TOKEN`, `TIKTOK_ADS_ACCESS_TOKEN`)
...
| "I don't know my account ID" | You need to discover it first | Meta: `meta businesses list` then `meta ad-accounts list --business-id ...`. Google: `google customers list`. TikTok: `tiktok advertisers list --app-id ... --app-secret ...` |
